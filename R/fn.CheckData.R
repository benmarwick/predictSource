...
>>>>>>> a4044eb98bd284312550dd6f57ccd4b33e59da4c
...
#'      if folder != " ": files, a list containing the folder name and the name of each of
#'         the excel files
#'
<<<<<<< HEAD
#'   USAGE
...
fn.CheckData <-
  function(doc = "fn.CheckData",
    ...
    if (folder == " ") out<-list(fcn.date.ver=fcn.date.ver,
                                 dataUsed=data,
                                 params=params,
