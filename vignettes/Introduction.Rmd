...
To execute the example code in the function documentation, the user can highlight that section of the code in the documentation in the window showing the function and use the Run toolbar button.  In windows, the user can also use Control/Enter.
