...
```
Table zz contains the data generating these nine points.  These are the same artifacts identified as having a potential for misclassification from the random forest analyis (TAble xx).
