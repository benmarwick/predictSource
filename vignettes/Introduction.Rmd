...
AnalyticVars=analyticVars, plotAllPoints=T, plotHullsOutsidePoints=F, plotOutsidePoints=F)
```
...
pca.eval <- fn.pca.evaluation(SourceData=ObsidianSources, ArtifactData=ObsidianArtifacts,
SourceGroup= "Code", ArtifactGroup="Code",known.sources=sources, predicted.sources=sources,
AnalyticVars=analyticVars, plotAllPoints=F, plotHullsOutsidePoints=T, plotOutsidePoints=F)
```
...
save.randomForest <- fn.randomForest(data=ObsidianSources, GroupVar="Code",Groups="All",
  ...
  predictSources=T, predictData=ObsidianArtifacts, plotSourceProbs=F) pca.eval <- fn.pca.evaluation(SourceData=ObsidianSources,
