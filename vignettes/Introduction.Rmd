...
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
CV.corr<-fn.CV.corr(data = ObsidianSources, GroupVar="Code", Groups="All", AnalyticVars=analyticVars, ByGroup=F)
...
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
CV.corr<-fn.CV.corr(data = ObsidianSources, GroupVar="Code", Groups = "All", AnalyticVars=analyticVars, ByGroup=T)
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.4: Example of a scatterplot for obsidian Jemez source data with confidence ellipses and robust lowess smoothing lines."} 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.5: Example of a scatterplot for obsidian Jemez source data with confidence ellipses and kernel smoothing lines."} 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
plot.2d <- fn.2dPlot(data = ObsidianSources, GroupVar = "Code", ID = "ID", Groups = c("A", "B"),
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.6: Example of a scatterplot for obsidian Jemez source data with the median values of and convex hulls of the points at each source."} 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.7: Example of a scatterplot for obsidian Jemez source data with data for all sources combined, confidence ellipses, and robust lowess smoothing lines."}
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
plot.2d <- fn.2dPlot(data = ObsidianSources, GroupVar = "Code", ID = "ID", Groups = "All",
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.8: Example of a three-dimensional plot showing data from three Jemez obsidian sources."}
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.8a: Q-Q plots of rubidium and zirconium, including the bivariate Q-Q plot, for the Jemez obsidian source data from source A." } 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.8b: Q-Q plots of rubidium and zirconium, including the bivariate Q-Q plot, for the Jemez obsidian source data from source B." } 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
```{r echo=FALSE, results='hide',message=FALSE, fig.cap="Figure 4.8c: Q-Q plots of rubidium and niobium for the Jemez obsidian source data from sources A and B." } 
library(karon)
data(ObsidianSources)
analyticVars<-c("Rb","Sr","Y","Zr","Nb")
...
The function fn.randomForest() does a random forest analysis on known group membership. The user can change the number of trees grown using the parameter Ntrees and the number of variables used with the parameter NvarUsed; the default value is NA, in which case the code chooses a value close to the square root of the number of predictor variables.  An analysis is reproducible if the random number generator used to select the bootstrap samples and the variables used has a specified starting value.  It is desirable to specify such a value, which must be a positive integer; the code has a default value of 11111. 
