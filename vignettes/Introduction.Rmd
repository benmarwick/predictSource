...
In contrast, in the corresponding plot based on the random forest analysis, these nine artifacts are predicted to come from the sources generating the convex hulls to which they are closest.  We encourage the reader to run the code (contained in the documentation for the function) generating that plot to verify this statement. 