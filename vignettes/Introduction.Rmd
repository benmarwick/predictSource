...
data(RbNb.pvalues)
data(RbZr.pvalues)
knitr::kable(RbZr.pvalues,caption="Table x.a.  P-values from test statistics for a bivariable Rb/Zr distribution.")
knitr::kable(RbNb.pvalues,caption="Table x.a.  P-values from test statistics for a bivariable Rb/Nb distribution.")
#
```