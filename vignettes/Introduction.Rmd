...
plot2dGauss<-ps_2dPlotGauss(data=ObsidianSources, GroupVar="Code", ID="ID", Groups=c("A","B"),
    AnalyticVars=analyticVars, variablePair=c("Rb","Nb"), qqPlot=F)
...
plot2dGauss<-ps_2dPlotGauss(data=ObsidianSources, GroupVar="Code", ID="ID", Groups="All",
    AnalyticVars=analyticVars, variablePair=c("Rb","Zr"), qqPlot=F, scatterPlot=F)
...
```{r}
plot2dGauss<-ps_2dPlotGauss(data=ObsidianSources, GroupVar="Code", ID="ID", Groups="All",
    AnalyticVars=analyticVars, variablePair=c("Rb","Nb"),qqPlot=F, scatterPlot=F)
